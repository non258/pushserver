...
int main() {
  ...
  inputdata("./" + filename + "val.txt", val, val_size);
//  for (int i = 0; i < val_size; i++)
//  {
//    std::cout << val[i] << std::endl;
//  }
//  return 0;
  inputdata("./" + filename + "col.txt", col, val_size);
//  for (int i = 0; i < val_size; i++)
//  {
//    std::cout << col[i] << std::endl;
//  }
//  return 0;
  inputdata("./" + filename + "row.txt", row, size+1);
//  for (int i = 0; i < size+1; i++)
//  {
//    std::cout << row[i] << std::endl;
//  }
//  return 0;
  inputdata("./" + std::to_string(size) + "b.txt", b, size);
//  for (int i = 0; i < size; i++)
//  {
...
#pragma omp parallel for
  ...
  const std::string fileName = "./" + filename + "k" + std::to_string(k) + "_result.txt";
